	...
	function getFoodRequest(searchTerm){
		...
		$.ajax({
			...
			success: function (data) {
				// Optional console log to see the data that is returned from Nutritionix API
				// console.info(data);
			...
			error: function (request, status, error) {
				// Optional console logs to get information about the errors returned from the Nutritionix API
